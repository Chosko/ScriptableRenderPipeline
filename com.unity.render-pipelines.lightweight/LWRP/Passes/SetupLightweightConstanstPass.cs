...
namespace UnityEngine.Experimental.Rendering.LightweightPipeline
{
    public class SetupLightweightConstanstPass : ScriptableRenderPass
    {
        ...
        void SetShaderKeywords(CommandBuffer cmd, ref CameraData cameraData, ref LightData lightData, ref ShadowData shadowData)
        {
            ...
            CoreUtils.SetKeyword(cmd, LightweightKeywordStrings.CascadeShadows, shadowData.directionalLightCascadeCount > 1 || shadowData.requiresScreenSpaceShadowCompute); //seongdae;
            CoreUtils.SetKeyword(cmd, LightweightKeywordStrings.DirectionalVxShadows, shadowData.directionalVxShadowMap != null);
